...
export default class AxisPad extends Component {
    ...
    render() {
        ...
        const BgComponent = this.props.backgroundSource ? ImageBackground : View;
        ...
        return (<Animated.View
            ...
            <BgComponent source={this.props.backgroundSource} style={[AxisPadStyle.wrapper, this.props.wrapperStyle ? this.props.wrapperStyle : {},{ width: this.state.width,
                height: this.state.width, }]}>
                <Animated.View
